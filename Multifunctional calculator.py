...
for i, key in enumerate(operations):
    b.Button(calculator, key, operations[key], row=2, col=i+3)

# btn_Add = b.Button(calculator, text='+', row=2, col=3)
# btn_Subtract = b.Button(calculator, text='-', row=2, col=4)
# btn_Expo = b.Button(calculator, text='x^y', row=2, col=6)
# btn_Root = b.Button(calculator, text='√', row=2, col=7)
